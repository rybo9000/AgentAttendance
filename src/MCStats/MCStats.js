      ...
      <section className="half" id="mcStat">
        ...
        <div className="mcStatContainer">
          <div className="mcStat">
            <div className="mcStatTop">{this.state.classes}</div>
            <div className="mcStatBottom">CLASSES</div>
          </div>
          <div className="mcStat">
            <div className="mcStatTop">{this.state.checkIns}</div>
            <div className="mcStatBottom">CHECK-INS</div>
          </div>
          <div className="mcStat">
            <div className="mcStatTop">{this.state.agents}</div>
            <div className="mcStatBottom">AGENTS</div>
          </div>
        </div>
